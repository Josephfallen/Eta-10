...
namespace Eta.Configs
{
    public class SpawnManager
    {
        ...
        [Description("The maximum number of times See No Evil can spawn per game.")]
        public int MaxSpawns { get; set; } = 1;

        [Description("Probability of a See No Evil Squad replacing a MTF spawn")]
        public int Probability { get; private set; } = 5;

        [Description("The maximum size of a See No Evil squad")]
        public int MaxSquad { get; private set; } = 30;

        [Description("Alpha 1 entrance Cassie Message")]
        public string RRRAnnouncementCassie { get; private set; } = "Mobile Task Force Unit eta-10 designated {designation} HasEntered AllRemaining AwaitingRecontainment {scpnum}";
